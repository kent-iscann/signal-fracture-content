...
Kazakhstan's defining foreign policy doctrine since independence. The concept is to maintain productive relationships with all major powers — Russia, China, the US, the EU, and regional actors — without firmly aligning with any single camp.

## Principles
- **Balance:** Avoid over-dependence on any single partner. Russia for security and trade routes, China for investment and BRI, the West for technology and capital.
- **Pragmatism:** Foreign policy serves economic development, not ideology. Kazakhstan will engage with any partner that offers tangible benefits.
- **Sovereignty:** Maintain formal independence in decision-making, even when economic realities create de facto dependence.

## Middle power evolution
- Under Tokayev, multi-vector diplomacy has evolved from a **defensive posture** ("balancer") to an **operating strategy** ("regional organizer").
- Kazakhstan is leveraging geography, energy resources, logistics, diplomatic reliability, and **convening power** to give structure to the space between great powers.
- Michel Duclos (Institut Montaigne) presents Kazakhstan as a test case for whether middle powers can still influence outcomes in an era of intensifying great power rivalry.
- The Regional Ecological Summit in Astana (bringing together nine heads of state) demonstrated Kazakhstan's convening capacity.
...
|- **South Korea axis (NEW — Sept 2026):** Tokayev's state visit to Seoul produced ~$19B in commercial agreements, elevated relations to "future-oriented comprehensive strategic partnership." Proposed joint Kazakh-Korean critical minerals company (Tau-Ken Samruk + POSCO). First Central Asia-ROK Summit held Sept 16. Represents a significant new vector in multi-vector diplomacy — Korea brings advanced manufacturing, critical minerals processing technology, and a non-great-power partnership that doesn't trigger balancing costs.\n- **US-China AI competition — new analysis (Sept 2026):** Andrew D'Anieri (National Interest) argues that if forced to choose between US and China AI blocs, Kazakhstan would choose China due to extensive BRI infrastructure and investment ties. Recommends US outcompete through compute power and supply chain building rather than ultimatums. Adds weight to the view that AI ultimatum is counterproductive.\n- **Russian gas imports create new dependency dimension (Sept 2026):** Kazakhstan signed supplementary agreement with Gazprom for ~11 bcm Russian gas — up sharply from ~4M bcm in 2025. Domestic production hit record 68.1 bcm but demand surging. Creates new energy dependency vector on Russia while US Congress passed sanctions bill targeting Russian energy purchasers.
...
- **Gulf sovereign wealth influx:** Abu Dhabi's $300B L'imad sovereign fund unveiled a $30B venture (May 2026) targeting energy, transport, and logistics across Central Asia — with BlackRock/GIP and Temasek as consortium partners. Gulf sovereign funds deployed $26B in Mar-May 2026, with Kazakhstan absorbing a growing share. Saudi PIF committed to joint ventures in petrochemicals and green hydrogen. This adds a new dimension to multi-vectorism: engagement with Gulf states now provides an alternative capital source that reduces dependence on any single great power.
- **US Russia sanctions bill breakthrough (July 2026):** Bipartisan US Senate agreement with the Trump administration to advance the "Sanctioning Russia Act," which would enable the US to punish countries helping Russia evade Western sanctions. This represents the most significant escalation of US secondary sanctions threat since the 2022 invasion. Directly relevant to Kazakhstan as a key transit corridor.
...
- In practice, Astana's posture leaned toward Gulf states, the US, and Israel — especially after Iranian retaliatory actions.
- Kazakhstan suspended several joint projects with Iran in April 2026 and emphasized the Middle Corridor.
- Oil price spikes from the conflict benefit Kazakhstan's budget in the short term.
- Kazakhstan participates in the Abraham Accords framework, signaling support for regional normalization without severing ties with Iran.
- Bilateral trade with Israel: ~$236M (2024); with Iran: ~$430M (2025).

## Military modernization
- Tokayev issued a strict two-year deadline for comprehensive military modernization.
- Defense deal with Turkey: ANKA UAV production facility in Kazakhstan.
- Diversifying military imports away from Russia: Chinese CHPL exports to Kazakhstan rose from $610M (2022) to $931M (2025).
- Tokayev downplayed suggestions of a Turkic military alliance while deepening defense partnerships.

## Mongolia axis
- Kazakhstan and Mongolia signed 18 intergovernmental agreements covering transport, trade, critical minerals, peaceful nuclear energy, and urban planning.
- New cross-border transport corridor cuts distance from 1,604km to 837km.
- Mongolia gains access to the Trans-Caspian Corridor and INSTC via Kazakhstan, expanding Kazakhstan's role as a continental logistics hub.
- Reflects both countries' shared structural position as landlocked, resource-based economies between major powers.

## Constitutional reform
- New constitution takes effect July 1, 2026, replacing the 1995 text.
- Introduces unicameral legislature (Kurultai), vice presidency, and People's Council.
