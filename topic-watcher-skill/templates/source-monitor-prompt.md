...
Step 0: Check if priority-sources.md exists at /root/wiki/{slug}/priority-sources.md. If it does, read it and follow this order:
...
Step 3: For each promising new source found, use tavily_extract to get the full content.
